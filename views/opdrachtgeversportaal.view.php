                ...
                <div class="container mb-xl">
                    <div class="grid">
                        ...
                        <div class="col-7">
                            ...
                            <h1 class="animatedText">Opdrachtgeversportaal</h1>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="grid content">
                <div class="col-6 col-offset-1">
                    <img src="../resources/images/project/opdrachtgeversportaal/header.png" alt="">
                </div>
            </div>
            <div class="grid content">
                ...
                <div class="col-1">
                    ...
                    <div class="project-data">
                        ...
                        <div class="desc">Opdrachtgeversportaal</div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="mb-xl">
        <div class="container">
            <div class="col-offset-1 col-6">
                <div class="mb-xl">
                    <h2>Wat is de opdrachtgeversportaal?</h2>
            ...
            <div class="grid mb-lg">
                <div class="col-offset-1 col-3 vertical-center hidden-xs">
                    <img src="../resources/images/project/opdrachtgeversportaal/asset-1.png" class="image-fluid">
                </div>
            ...
            <div class="grid mb-lg">
                ...
                <div class="col-3 vertical-center">
                    <img src="../resources/images/project/opdrachtgeversportaal/asset-2.png" class="image-fluid">
                </div>
            </div>

            <div class="grid mb-lg">
                <div class="col-offset-1 col-3 vertical-center hidden-xs">
                    <img src="../resources/images/project/opdrachtgeversportaal/asset-3.png" class="image-fluid">
                </div>
            ...
            <div class="grid mb-lg">
                ...
                <div class="col-3 vertical-center">
                    <img src="../resources/images/project/opdrachtgeversportaal/asset-4.png" class="image-fluid">
                </div>
            </div>
            ...
            <div class="grid">
                <div class="col-6 col-offset-1">
                    <ul class="accordion">
                        <li class="active">
                            ...
                            <div class="body">
                                <div class="grid">
                                    ...
                                    <div class="col-2"><span class="label">Documentatie</span>
                                        <ul class="striped inside">
                                            <li>Confluence</li>
                                            <li>Miro</li>
                                            <li>Azure DevOps</li>
                        ...
                        <li>
                            <div class="head">
                                <div class="title">Samenwerkingen</div>
                            </div>
                            <div class="body">
                                <div class="grid">
                                    <div class="col-2"><span class="label">Team samenstelling</span>
                                        <ul class="striped inside">
                                            <li>1 Teamlead</li>
                                            <li>1 Test Engineer</li>
                                            <li>2 UX-Designer</li>
                                            <li>3 Business Analisten</li>
                                            <li>4 Developers</li>
                                        </ul>
                                    </div>
                                </div>
