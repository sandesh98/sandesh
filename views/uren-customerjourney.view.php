            ...
            <div class="vcenter">
                <div class="container mb-xl">
                    <div class="grid">
                        ...
                        <div class="col-7">
                            <div class="label">Augustus</div>
                            <h1 class="animatedText">Customer Journey urenregistratie</h1>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="grid content">
                <div class="col-6 col-offset-1">
                    <img src="../resources/images/project/urencustomerjourney/header.png" alt="">
                </div>
            </div>
            <div class="grid content">
