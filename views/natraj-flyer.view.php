...
<div id="inner">
    <section class="nmb behind-header">
        <div class="hero">
            <div style="background-image: url('resources/images/project/natrajflyer/header.jpg');" class="bg faded"></div>
            <div class="vcenter">
        ...
        <div class="container">
            <div class="grid content">
                <div class="col-6 col-offset-1">
                    <img src="resources/images/project/natrajflyer/preview.jpg" alt="">
                </div>
            </div>
            <div class="grid content">
                ...
                <div class="col-6 col-offset-1">
                    <div class="col-4">
                        <div class="vcenter link-container">
                            <a href="/guess-and-win" class="prev-link">
                    ...
                    <div class="col-4">
                        <div class="vcenter link-container text-right">
                            <a href="/dutchdiner" class="next-link">
