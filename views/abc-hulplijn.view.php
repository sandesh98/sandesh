...
<div id="inner">
    <section class="nmb behind-header">
        <div class="hero">
            <div style="background-image: url('../resources/images/project/abchulplijn/header.jpg');" class="bg faded"></div>
            <div class="vcenter">
        ...
        <div class="container">
            <div class="grid content">
                <div class="col-6 col-offset-1">
                    <img src="../resources/images/project/abchulplijn/preview.jpg" alt="">
                </div>
            </div>
            <div class="grid content">
        ...
        <div class="container">
            <div class="grid content">
                <div id="img-carousel" class="titanSlider">
                    <ul class="slides">
                        <li class="slide"><img src="../resources/images/project/abchulplijn/carousel/carousel-1.jpg" class="fw"></li>
                        <li class="slide"><img src="../resources/images/project/abchulplijn/carousel/carousel-2.jpg" class="fw"></li>
                        <li class="slide"><img src="../resources/images/project/abchulplijn/carousel/carousel-3.jpg" class="fw"></li>
                        <li class="slide"><img src="../resources/images/project/abchulplijn/carousel/carousel-4.png" class="fw"></li>
                    </ul>
                </div>
            </div>
        </div>
                ...
                <div class="col-6 col-offset-1">
                    <div class="col-4">
                        <div class="vcenter link-container">
                            <a href="/superspeurders" class="prev-link">
                    ...
                    <div class="col-4">
                        <div class="vcenter link-container text-right">
                            <a href="/pscateringservices" class="next-link">
