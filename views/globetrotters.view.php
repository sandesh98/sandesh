            ...
            <div class="grid content">
                ...
                <div class="col-offset-1 col-1">
                    <div class="project-data">
                        ...
                        <div class="desc">Hike One</div>
                    </div>
                    <div class="project-data">
                        <div class="title">Type</div>
                        <div class="desc">Prototype + AR-applicatie</div>
                    </div>
                </div>
                <div class="col-1">
                    <div class="project-data">
                        <div class="title">Jaar</div>
                        <div class="desc">2023</div>
                    </div>
                    <div class="project-data">
                        <div class="title">Soort</div>
                        <div class="desc">Minor opdracht</div>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-6 col-offset-1">
                    <div class="col-4">
                        <div class="vcenter link-container">
                            <a href="/customerjourney" class="prev-link">
